...
const MOCK_DATA = {
  "John": {
    ...
    subtotal: 45.50,
    items: [
      { name: "Burger", price: 15.00, users: 1 },
      { name: "Fries", price: 8.50, users: 2 },
      { name: "Soda", price: 4.00, users: 1 },
      { name: "Salad", price: 18.00, users: 1 }
    ]
  },
  "Sarah": {
    name: "Sarah",
    subtotal: 32.25,
    items: [
      { name: "Pasta", price: 22.00, users: 1 },
      { name: "Fries", price: 8.50, users: 2 },
  ...
  "Mike": {
    ...
    subtotal: 28.50,
    items: [
      { name: "Pizza", price: 20.00, users: 1 },
      { name: "Wings", price: 8.50, users: 1 }
    ]
  }
};

const ReviewWrapper = ({ setStep }) => {
  ...
  return (
    <View style={styles.rootContainer}>
      ...
      <View style={styles.innerContainer}>
        ...
        >
          <ReviewScreen isDragging={isDragging} processed={processedData} />
        </Animated.View>
